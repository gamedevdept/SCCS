...
#include "city.h"
#define location 60 //ui 좌우로 위치조정용 -> 메인게임에서 어떻게 이쁘게 맞추냐...
...
void CleaningGame::run() {
    while (1) {
        ...
        cout << "\033[13;45H┌────────────────────────────────────────────┐\n";
        cout << "\033[19;45H└────────────────────────────────────────────┘\n";
        cout << "\033[15;45H   주운 쓰레기 개수 : " << point << "\n";
        cout << "\033[16;45H   방향입력(wasd) : ";
        cin >> dir;
        movePlayer(dir);
        ...
        if (collision) {
            ...
            cout << "\033[19;45H└────────────────────────────────────────────┘\n";
            cout << "\033[15;45H   주운 쓰레기 개수 : " << point << "\n";
            cout << "\033[16;45H   당신은 청소를 하다가 사람과 부딪혔습니다! \n";
            cout << "\033[17;45H   받은 알바비 : " << point << " * 100 = " << Money << "\n";
            cout << "\033[18;45H   아무 키나 눌러 게임 종료";
            cout << "\033[20;0H";
            city.money += Money;
            break;
        ...
        if (gameClear) {
            ...
            cout << "\033[19;45H└────────────────────────────────────────────┘\n";
            cout << "\033[15;45H   주운 쓰레기 개수 : " << point << "\n";
            cout << "\033[16;45H   당신은 무사히 청소를 마쳤습니다! \n";
            cout << "\033[17;45H   받은 알바비 : " << point << " * 100 = " << Money << "\n";
            cout << "\033[18;45H   아무 키나 눌러 게임 종료";
            cout << "\033[20;0H";
            city.money += Money;
